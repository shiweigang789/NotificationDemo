...
public class NotificationEffectActivity extends Activity implements View.OnClickListener {
    ...
    private void showNotifyWithRing() {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                ...
                //调用自己提供的铃声
//                .setSound(Uri.parse("android.resource://com.lovely.pig.notificationdemo/" + R.raw.beep));
                .setSound(Uri.parse("android.resource://com.lovely.pig.notificationdemo/" + R.raw.sound));
        //另一种设置铃声的方法
